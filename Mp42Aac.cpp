...
//{{{
static AP4_Result WriteAdtsHeader(AP4_ByteStream* output,
...
//}}}
//{{{
static void DecryptAndWriteSamples (AP4_Track* track, AP4_SampleDescription* sdesc,
                                    AP4_Byte* key, AP4_ByteStream* output) {
...
//}}}
//{{{
static void WriteSamples(AP4_Track*             track,
