...
//{{{
static void ShowPayload(AP4_Atom& atom, bool ascii = false)
{
...
//}}}
//{{{
static void ShowData(const AP4_DataBuffer& data)
{
...
//{{{
static void ShowProtectionSchemeInfo_Text(AP4_UI32 scheme_type, AP4_ContainerAtom& schi, bool verbose)
{
...
//}}}
//{{{
static void ShowProtectionSchemeInfo_Json(AP4_UI32 /* scheme_type */, AP4_ContainerAtom& /* schi */, bool /* verbose */)
{
    // not implemented yet
}
...
//}}}
//{{{
static void ShowProtectedSampleDescription_Text(AP4_ProtectedSampleDescription& desc, bool verbose)
{
    printf("    [ENCRYPTED]\n");
    char coding[5];
...
//}}}
//{{{
static void ShowProtectedSampleDescription_Json(AP4_ProtectedSampleDescription& desc, bool verbose)
{
    printf("\"protection\":{\n");
    char coding[5];
    AP4_FormatFourChars(coding, desc.GetFormat());
...
//{{{
static void ShowMpegAudioSampleDescription(AP4_MpegAudioSampleDescription& mpeg_audio_desc)
{
...
//{{{
static void ShowDcfInfo(AP4_File& file)
{
...
//{{{
static void ShowAvcInfo(const AP4_DataBuffer& sample_data, AP4_AvcSampleDescription* avc_desc)
{
...
//}}}
//{{{
static void ShowSample_Text(AP4_Track&      track,
                AP4_Sample&     sample,
...
//}}}
//{{{
static void ScanMedia(AP4_Movie& movie, AP4_Track& track, AP4_ByteStream& stream, MediaInfo& info)
{
...
//{{{
static void ShowTrackInfo_Text(AP4_Movie& movie, AP4_Track& track, AP4_ByteStream& stream, bool show_samples, bool show_sample_data, bool verbose, bool fast)
{
...
//}}}
//{{{
static void ShowTrackInfo_Json(AP4_Movie& movie, AP4_Track& track, AP4_ByteStream& stream, bool /*show_samples*/, bool /*show_sample_data*/, bool verbose, bool fast)
{
    printf("{\n");
    printf("  \"flags\":%d,\n", track.GetFlags());
    printf("  \"flag_names\":[");
...
//}}}
//{{{
static void ShowTrackInfo(AP4_Movie& movie, AP4_Track& track, AP4_ByteStream& stream, bool show_samples, bool show_sample_data, bool verbose, bool fast)
{
    switch (Options.format) {
        case TEXT_FORMAT:
...
//}}}
//{{{
static void ShowMovieInfo(AP4_Movie& movie)
{
    switch (Options.format) {
        case TEXT_FORMAT:
            printf("Movie:\n");
...
//{{{
static void ShowFileInfo(AP4_File& file)
{
...
//}}}
//{{{
static void ShowTracks(AP4_Movie& movie, AP4_List<AP4_Track>& tracks, AP4_ByteStream& stream, bool show_samples, bool show_sample_data, bool verbose, bool fast)
{
...
//}}}
//{{{
static void ShowMarlinTracks(AP4_File& file, AP4_ByteStream& stream, AP4_List<AP4_Track>& tracks, bool show_samples, bool show_sample_data, bool verbose, bool fast)
{
...
//}}}
//{{{
static void ShowSampleLayout(AP4_List<AP4_Track>& tracks, bool /* verbose */)
{
...
//}}}
//{{{
static void ShowFragments_Text(AP4_Movie& movie, bool verbose, bool show_sample_data, AP4_ByteStream* stream)
{
    stream->Seek(0);
    AP4_LinearReader reader(movie, stream);
